...
const TCHAR* CvUnitArtStyleTypeInfo::getEarlyArtDefineTag(int i, int j) const
{
	FASSERT_BOUNDS(0, GC.getNumUnitInfos(), j, "CvUnitArtStyleTypeInfo::getEarlyArtDefineTag");
...
void CvUnitArtStyleTypeInfo::setEarlyArtDefineTag(int i, int j, const TCHAR* szVal)
{
	FASSERT_BOUNDS(0, GC.getNumUnitInfos(), j, "CvUnitArtStyleTypeInfo::setEarlyArtDefineTag");
...
const TCHAR* CvUnitArtStyleTypeInfo::getLateArtDefineTag(int i, int j) const
{
	FASSERT_BOUNDS(0, GC.getNumUnitInfos(), j, "CvUnitArtStyleTypeInfo::getLateArtDefineTag");
...
void CvUnitArtStyleTypeInfo::setLateArtDefineTag(int i, int j, const TCHAR* szVal)
{
	FASSERT_BOUNDS(0, GC.getNumUnitInfos(), j, "CvUnitArtStyleTypeInfo::setLateArtDefineTag");
...
const TCHAR* CvUnitArtStyleTypeInfo::getMiddleArtDefineTag(int i, int j) const
{
	FASSERT_BOUNDS(0, GC.getNumUnitInfos(), j, "CvUnitArtStyleTypeInfo::getMiddleArtDefineTag");
...
void CvUnitArtStyleTypeInfo::setMiddleArtDefineTag(int i, int j, const TCHAR* szVal)
{
	FASSERT_BOUNDS(0, GC.getNumUnitInfos(), j, "CvUnitArtStyleTypeInfo::setMiddleArtDefineTag");
