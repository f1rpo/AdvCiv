...
*/
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_NEW_RANDOM_SEED", GAMEOPTION_NEW_RANDOM_SEED) // advc.701
	...
	python::enum_<ContactTypes>("ContactTypes")
		...
		;
	// advc.130p: Added MEMORY_CANCELLED_DEFENSIVE_PACT and MEMORY_INDEPENDENCE
	// advc.143: Added MEMORY_CANCELLED_VASSAL_AGREEMENT
