...
void TestScaledInt()
{
	...
	/*	Fixme: Bizarrely, I get an "unexpected end of file" compilation error here
		...
		Probably a compiler bug related to scaleForComparison. That said, the VS2010
		debugger also gets confused: F10 makes a double step. Will have to look for
		a better workaround for the scaleForComparison return type. */
